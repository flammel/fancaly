...
},{"js-base64":"9GjXb","./execute":"37vz6"}],"9GjXb":[function(require,module,exports) {
...
},{}],"37vz6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function execute(input) {
    ...
    for (const line of lines)environment.addResult((0, _lex.lex)(line).chain((0, _parse.parse)).chain((ast)=>(0, _evaluate.evaluate)((0, _context.defaultContext), environment, ast)));
    return environment.getOutput().join("\n");
}

},{"./lex":"16xgm","./parse":"dddDq","./evaluate":"80V3z","./Context":"iMQ69","./Environment":"6bSA7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"16xgm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dddDq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@badrap/result":"jmsn1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./assertNever":"hMdRz"}],"hMdRz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@badrap/result":"jmsn1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Value":"911Zn","./assertNever":"hMdRz"}],"911Zn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Value {
    constructor(bignum, unit){
        this.unit = unit;
        this.bignum = new (0, _bignumberJsDefault.default)(bignum);
    }
    toString() {
    ...
    dividedBy(other) {
        if (this.unit !== undefined || other.unit !== undefined) return (0, _result.Result).err(new Error("Cannot divide values with units"));
        return (0, _result.Result).ok(new Value(this.bignum.dividedBy(other.bignum), this.unit));
    }
    pow(other) {
        if (this.unit !== undefined || other.unit !== undefined) return (0, _result.Result).err(new Error("Cannot pow values with units"));
        return (0, _result.Result).ok(new Value(this.bignum.pow(other.bignum), this.unit));
    }
    negated() {
    ...
    static sum(values) {
        ...
        else result = result.chain((prev)=>prev.plus(value));
        return result === undefined ? (0, _result.Result).err(new Error("No values")) : result;
    }
...
},{"bignumber.js":"57qkX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@badrap/result":"jmsn1"}],"57qkX":[function(require,module,exports) {
...
},{}],"iMQ69":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _value = require("./Value");
class Context {
    constructor(units, operators, aggregators){
        this.units = units;
    ...
    getUnit(name) {
        ...
        return unit === undefined ? (0, _result.Result).err(new Error("Unknown unit " + name)) : (0, _result.Result).ok(unit);
    }
    getOperator(name) {
        const operator = this.operators.find((a)=>a.name === name);
        return operator === undefined ? (0, _result.Result).err(new Error("Unknown operator " + name)) : (0, _result.Result).ok(operator);
    }
    getAggregator(name) {
        const aggregator = this.aggregators.find((a)=>a.name === name);
        return aggregator === undefined ? (0, _result.Result).err(new Error("Unknown aggregator " + name)) : (0, _result.Result).ok(aggregator);
    }
}
const defaultContext = new Context([
    ...
    {
        name: "sum",
        operation: (xs)=>(0, _value.Value).sum(xs)
    },
    {
        name: "average",
        operation: (xs)=>(0, _value.Value).average(xs)
    }, 
]);

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Value":"911Zn","@badrap/result":"jmsn1"}],"6bSA7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Environment", ()=>Environment);
var _result = require("@badrap/result");
class Environment {
    constructor(variables = new Map(), results = []){
    ...
    getVariable(name) {
        ...
        return value === undefined ? (0, _result.Result).err(new Error("Undefined variable " + name)) : (0, _result.Result).ok(value);
    }
    addResult(result) {
    ...
    getAggregatorValues() {
        let values = [];
        for (const result of this.results)if (result.isErr) values = [];
        else values.push(result.value);
        return values;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@badrap/result":"jmsn1"}]},["iJYvl","h7u1C"], "h7u1C", "parcelRequire52f6")
